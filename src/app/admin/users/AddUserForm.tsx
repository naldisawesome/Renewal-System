            ...
            {created ? (
              <div className="space-y-3">
                <div className="rounded-md bg-green-50 border border-green-200 px-4 py-3 text-sm text-green-800">
                  ...
                  <p className="mt-2 font-mono text-xs bg-white dark:bg-slate-900/60 rounded px-2 py-1 inline-block break-all">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="flex items-center justify-between">
                  <h2 className="font-medium text-slate-900 dark:text-slate-100">Add a user</h2>
                  <button type="button" onClick={closeModal} className="text-sm text-slate-400 dark:text-slate-500">
                    Cancel
                  </button>
                </div>
