...
export default function RenewalsTable({
  ...
  const columnCount = canManage ? 14 : 13;
    ...
    <div className="space-y-3">
      ...
      <div className="card overflow-x-auto">
        <table className="w-full table-fixed text-sm">
          <colgroup>
            {canManage && <col className="w-[2.5%]" />}
            <col className={canManage ? "w-[15%]" : "w-[17.5%]"} />
            <col className="w-[7%]" />
            <col className="w-[8%]" />
            <col className="w-[10%]" />
            <col className="w-[7%]" />
          ...
          <thead className="bg-slate-50 dark:bg-slate-800 text-left text-xs uppercase text-slate-500 dark:text-slate-400">
            <tr>
              ...
              <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Client</th>
              <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Policy #</th>
              <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Insurer</th>
              <SortableTh
                label="Type"
                sortKey="bookType"
              ...
              <SortableTh
                ...
                basePath="/admin/renewals"
              />
              <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Invoice Total</th>
              <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Target GWP</th>
              <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Actual GWP</th>
              <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Adviser</th>
              <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Underwriter</th>
              <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Status</th>
              <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Notes</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-slate-100 dark:divide-slate-700">
            ...
            {renewals.length === 0 && (
              <tr>
                <td colSpan={columnCount} className="px-4 py-10 text-center text-slate-400 dark:text-slate-500">
