      ...
      <table className="w-full table-fixed text-sm">
        ...
        <thead className="bg-slate-50 dark:bg-slate-800 text-left text-xs uppercase text-slate-500 dark:text-slate-400">
          <tr>
            ...
            <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Type</th>
            <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Renewal Date</th>
            <th className="px-3 py-3 whitespace-nowrap overflow-hidden text-ellipsis">Month/Year</th>
